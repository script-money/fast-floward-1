    ...
    case 'setListings': {
      return {
        ...
        listings: action.payload.map((listing) => ({
          ...listing,
          picture: new Picture(
            listing.canvas.pixels,
            listing.canvas.width,
            listing.canvas.height
          ),
      ...
      <table className="table is-fullwidth is-striped is-narrow">
        <thead>
          <tr>
            <th>Picture</th>
            <th>Seller</th>
            <th className="is-justify-content-flex-end has-text-right">
              Price
            </th>
            <th></th>
          </tr>
            ...
            state.listings.map((listing, index) => {
              ...
              return (
                <tr key={listing.picture.pixels}>
                  <td>
                    <Frame pixel={Pixel.thumbnail} picture={listing.picture} />
                  </td>
